...
def prepare_environment():
    ...
    if args.use_ipex:
        if platform.system() == "Windows":
            ...
            torch_command = os.environ.get('TORCH_COMMAND', f"pip install torch==2.1.0a0 intel-extension-for-pytorch==2.1.10 torchvision==0.16.0a0 --extra-index-url {torch_index_url}")
